...
public class Graph {
    ...
    public void traverseBreadthFirst(String root){
        // we use a queue instead of using a stack.
        var node = nodes.get(root);
        if (node == null)
            return;
        ...
        while(!queue.isEmpty()){
            ...
            //look at the unvisited neighbouors  by adding the neighbours to the end of the queue.
            for (var neighbour : adjacencyList.get(current))
                if (!visited.contains(neighbour))
                    queue.add(neighbour);
        }
    ...
    public boolean hasCycle(){
        ...
        while(!all.isEmpty()){
            ...
            // start a dpeth first search on this node
